...
function Register() {
  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await axios.post(`${window.location.origin}/api/users/register`, values);
  ...
  return (
    <div className="h-screen d-flex justify-content-center align-items-center auth">
      <div className="w-400 card p-3">
        <h1 className="text-lg">SWIFT - Register</h1>
        <hr />
        <Form
          form={form}
          layout="vertical"
        ...
        >
          ...
          >
            <div className="password-input-container">
              <input type={type} onChange={onPasswordChange} />
